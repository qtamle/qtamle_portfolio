  ...
  <form class="relative right-0 h-full flex flex-col h-content-headless-toolbox">
    ...
    <div class="bg-window-white border-window-header-bot w-full h-18 flex items-center flex-col p-2 text-xxs gap-2 ">
      <label class="w-full flex gap-2 font-trebuchet-pixel">
        ...
        <input type="text" class="w-full h-5 border border-input-blue p-1.5 text-xs outline-none placeholder:text-black" placeholder="lequoctamle55@gmail.com" readonly="readonly"/>
      </label>
      <label class="w-full flex gap-2">
        ...
        <input v-model="userEmail" type="email" class="w-full h-5 border border-input-blue p-1.5 text-xs outline-none font-trebuchet-pixel" placeholder="your@gmail.com"/>
      </label>
      <label class="w-full flex gap-2">
